...
def test_load_intents(language: str) -> None:
    ...
    # A supported language has to be a language. The list is generated by globbing
    # data/*.json, so any other JSON left in there is offered to callers as one,
    # and get_intents() would return it without complaint.
    assert lang_intents.get("language") == language
